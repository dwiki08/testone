...
final class $$CategoriesTableReferences
  ...
  static MultiTypedResultKey<$FoodsTable, List<FoodEntity>> _foodsRefsTable(
    _$AppDatabase db,
  ) => MultiTypedResultKey.fromTable(
    db.foods,
    aliasName: $_aliasNameGenerator(db.categories.id, db.foods.categoryId),
  );
...
final class $$FoodsTableReferences
    extends BaseReferences<_$AppDatabase, $FoodsTable, FoodEntity> {
  $$FoodsTableReferences(super.$_db, super.$_table, super.$_typedResult);

  static $CategoriesTable _categoryIdTable(_$AppDatabase db) => db.categories
      .createAlias($_aliasNameGenerator(db.foods.categoryId, db.categories.id));
...
class $$FoodsTableTableManager
    extends
        RootTableManager<
          ...
          (FoodEntity, $$FoodsTableReferences),
          FoodEntity,
